...
\begin{frontmatter}
    ...
    \author{Bernardo Sulzbach, Leonardo Ferrazza}

    \address{Rio Grande do Sul, Brazil}

    \begin{abstract}
    This paper compares the performance of insertions, deletions and queries of varying sizes on both unbalanced binary search trees and AVL trees.
    \end{abstract}
...
\begin{figure}[h]
    \centering\includegraphics[width=0.4\linewidth]{cat.png}
